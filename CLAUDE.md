...
- **Core services (each gets its own page):** performance ECU tuning, turbo &
  ...
  diagnostics, drivetrain / clutch, exhaust & intake. (JDM import service was
  removed 2026-09-07; pre-purchase inspections and track prep 2026-09-11. The
  business does not offer them and their URLs redirect to `/services`.)
